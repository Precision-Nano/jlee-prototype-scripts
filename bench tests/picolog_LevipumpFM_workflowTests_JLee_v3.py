...
Test plan H (no Bronkhorst data). Compiled results in "resultsArr2".
...
nameStr = 'LFM06 - Apr 1, 2022 1-44-31 PM'
...
for filename in os.listdir(pathName):
    if nameStr in filename and '.csv' in filename:# and int(test) <= int(testEnd):
        ...
        resultsArr = np.hstack((testNum, wat, eth, cst, ssRPM, tPumpi, t1_LFM, t1_dLFM, maxErr_LFM, tEnd2, ssLFM, min_LFM, max_LFM, t1_LC, t2_LC, dm, LCfr, avgP, temp2))
