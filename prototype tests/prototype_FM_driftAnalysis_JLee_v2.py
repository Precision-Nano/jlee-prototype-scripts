...
wsCFs =  451.6516773 # from load cell calibration.
wsCFi =  0.685485616 #from load cell calibration.
...
fillcycle = 7
# threshP = .2
threshSt = 0 # unit seconds.
threshEnd = 150 # unit seconds.
threshInc = 15 # unit seconds.
